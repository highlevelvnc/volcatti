...
export const GALLERY: ReadonlyArray<GalleryItem> = [
  ...
  {
    slug: "remodelacao-interior-lisboa",
    src: "/portfolio/remodelacoes.jpg",
    alt: "Remodelação interior Volcatti — acabamentos finos",
    title: "Remodelação Interior",
    cat: "remodelacao",
    area: "92 m²",
    year: "2025",
    location: "Lisboa",
    duration: "62 dias úteis",
    scope: "Demolição · Canalização · Elétrica · Acabamentos",
    description:
      "Remodelação total de apartamento em Lisboa. Demolição faseada, canalização e elétrica novas, carpintaria à medida e pintura técnica. Entrega pronta a habitar.",
  },
  {
    slug: "construcao-civil-sintra",
    src: "/portfolio/construcao-civil.jpg",
    alt: "Obra Volcatti — construção civil em estrutura",
    title: "Construção Civil",
    cat: "construcao",
    area: "210 m²",
    year: "2025",
    location: "Sintra",
    duration: "10 meses",
    scope: "Fundação · Estrutura · Fachada · Acabamentos",
    description:
      "Construção de moradia unifamiliar de raiz em Sintra. Estrutura armada, fachada ventilada, cobertura técnica e acabamentos premium. Coordenação completa de equipa própria e fornecedores certificados.",
  },
  {
    slug: "quadro-eletrico-lisboa",
    src: "/portfolio/servicos-eletricos.jpg",
    alt: "Quadro elétrico Volcatti — instalação técnica certificada",
    title: "Quadro Técnico Elétrico",
    cat: "eletrica",
    area: "—",
    year: "2025",
    location: "Lisboa",
    duration: "6 dias úteis",
    scope: "Quadro · Circuitos · Certificação CERTIEL",
    description:
      "Instalação completa de quadro elétrico técnico com circuitos novos, disjuntores diferenciais e protetores de sobretensão. Certificação CERTIEL emitida no fim da obra.",
  },
];
